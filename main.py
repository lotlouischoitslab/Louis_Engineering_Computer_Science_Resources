...
# background = pygame.image.load('gitcheatsheet.png')
# player = pygame.image.load('gitcheatsheet.png')
# running = True
# while running:
#     for event in pygame.event.get():
#         if event.type == pygame.QUIT:
#             running = False
#     screenA.blit(background, (20,10))
...
tex = Texture.from_surface(renderer, load_img("gitcheatsheet.png"))
...
win2.opacity = 0.5
win2.set_icon(load_img("gitcheatsheet.png"))
